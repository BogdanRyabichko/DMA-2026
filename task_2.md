...
## Критерии оценки и регламент сдачи

Выполнение практической работы оценивается по балльно-рейтинговой системе (максимум 100 баллов).

| Элемент контроля                         | Баллы | Требования к качеству                                                                            |
| :--------------------------------------- | :---- | :----------------------------------------------------------------------------------------------- |
| **Тематические мини-задания (Темы 1–9)** | 45    | По 5 баллов за каждый полностью решенный блок заданий (по 1 баллу за задачу).                    |
| **Смешанные задания (50 задач)**         | 40    | Решение минимум 20 выбранных преподавателем или студентом сквозных задач (по 2 балла за задачу). |
| **Архитектура и Code Style**             | 10    | Соблюдение Google Java Style Guide, осмысленное именование пакетов, методов и констант.          |
| **Защита работы (собеседование)**        | 5     | Ответы на теоретические вопросы по полиморфизму, интерфейсам и типам данных Java.                |

### Рекомендации по оформлению отчета

1. Исходный код должен быть выложен в персональный репозиторий GitHub или GitLab.
2. В корневой директории репозитория должен присутствовать файл `README.md` со структурой проекта и скриншотами выполнения консольных тестов.
3. Код должен компилироваться без предупреждений и ошибок линтера.
